    ...
    public function run(): void
    {
        ...
        $settings = [
            ...
            [
                ...
                'description' => 'OCR method to use (google_vision, ocrspace, or tesseract)',
                'category' => 'ocr',
                'type' => 'select',
                'default_value' => 'google_vision',
                'options' => ['google_vision' => 'Google Vision API (Cloud)', 'ocrspace' => 'OCR.space (Cloud)', 'tesseract' => 'Tesseract (Local)'],
                'validation_rules' => ['required', 'in:google_vision,ocrspace,tesseract'],
                'sort_order' => 8,
            ],
            [
                'key' => 'ocr.google_vision_api_key',
                'display_name' => 'Google Vision API Key',
                'description' => 'API key for Google Cloud Vision API service',
                'category' => 'ocr',
                'type' => 'string',
                'default_value' => '',
            ...
            [
                ...
                'description' => 'Maximum time to wait for OCR API response',
                'category' => 'ocr',
                'type' => 'integer',
                'default_value' => '120',
